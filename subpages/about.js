...
let questions = [
    {
        data: "Started from the bottom Aditya started to work in small startups to gain experience and used it all together to make ChitkaraKart.",
    ...
    {
        data: "Aditya Pursuing his B-tech from Chitkara University hence named his startup ChitkaraKart.",
